resource "azurerm_virtual_machine_extension" "deploy" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": [
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/common_scripts/utils.sh",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/common_manifests/bosh.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/common_manifests/cloud-config.yml",
                    ...
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/scripts/setup_env.sh",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/manifests/cf-deployment.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/manifests/azure.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/manifests/scale-to-one-az.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/manifests/small-vm.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/manifests/use-azure-storage-blobstore.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/dynamic_ip/cf-lite/releases/all-in-one-release.tgz",
