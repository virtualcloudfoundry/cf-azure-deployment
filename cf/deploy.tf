resource "azurerm_virtual_machine_extension" "deploy" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": ["https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/common_scripts/utils.sh",
                    ...
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/use-service-principal-with-certificate.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/cloud-config.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/cf-deployment.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/azure.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/scale-to-one-az.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/use-azure-storage-blobstore.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/aci.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/no-aci.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/manifests/debug.yml",
                    "https://raw.githubusercontent.com/virtualcloudfoundry/cf-azure-deployment/vmss_support_libvhd/cf/scripts/setup_env.sh",
