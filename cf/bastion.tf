resource "azurerm_virtual_machine" "bastion" {
  ...
  os_profile {
    ...
    custom_data = <<CUSTOM_DATA
    {
      ...
      "STEMCELL_URL":"https://opensourcerelease.blob.core.windows.net/stemcells/bosh-stemcell-2222.25-azure-hyperv-ubuntu-xenial-go_agent.tgz",
      "STEMCELL_SHA1":"2933df8b4bd0f513c9f739f39960f2df7f0b459e",
