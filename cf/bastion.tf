resource "azurerm_virtual_machine" "bastion" {
  ...
  os_profile {
    ...
    custom_data = <<CUSTOM_DATA
    {
      ...
      "STEMCELL_URL":"https://opensourcerelease.blob.core.windows.net/stemcells/bosh-stemcell-2222.24-azure-hyperv-ubuntu-xenial-go_agent.tgz",
      "STEMCELL_SHA1":"74bae7b059d2e1cf8268b7dd7e0b0df73e6bf01f",
