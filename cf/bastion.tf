resource "azurerm_virtual_machine" "bastion" {
  ...
  os_profile {
    ...
    custom_data = <<CUSTOM_DATA
    {
      ...
      "STEMCELL_URL":"https://opensourcerelease.blob.core.windows.net/stemcells/bosh-stemcell-2222.90-azure-hyperv-ubuntu-xenial-go_agent.tgz",
      "STEMCELL_SHA1":"aa72c64d9fdfba3d0a927f526d402c40e681d9f8",
