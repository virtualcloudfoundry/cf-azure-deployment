resource "azurerm_virtual_machine" "bastion" {
  ...
  os_profile {
    ...
    custom_data = <<CUSTOM_DATA
    {
      ...
      "STEMCELL_URL":"https://opensourcerelease.blob.core.windows.net/stemcells/bosh-stemcell-2222.88-azure-hyperv-ubuntu-xenial-go_agent.tgz",
      "STEMCELL_SHA1":"9a10f7c88570b68b721cbd3b406abb1ee9f30e04",
